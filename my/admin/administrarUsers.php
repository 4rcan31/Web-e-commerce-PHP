			...
			<div class="row" >
				<div class="col-sm-12 col-md-12 col-lg-6">
					<form id="frmArticulos" enctype="multipart/form-data" method="POST">
						...
						<label>usuario</label>
						<input type="text" class="form-control input-sm" id="cantidad" name="usuario">
						<label>Password</label>
						<input type="text" class="form-control input-sm" id="precio" name="password">
                        <br>
						<p></p>
                        <button class="btn btn-primary" name = "button-users">
                        <span>Agregar</span>
                        </button>
					</form>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-6">
                    ...
                    <caption><label>Usuarios :D</label></caption>
...
<?php 
require_once "backend/validacionesAdministrarUsers.php"; //Validaciones backen.
?>
